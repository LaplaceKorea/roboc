#ifndef ROBOC_TERMINAL_STATE_EQUATION_HPP_
#define ROBOC_TERMINAL_STATE_EQUATION_HPP_
...
#include "roboc/ocp/terminal_state_equation.hxx"

#endif // ROBOC_TERMINAL_STATE_EQUATION_HPP_ 