#ifndef ROBOC_SPLIT_SWITCHING_CONSTRAINT_RESIDUAL_HPP_ 
#define ROBOC_SPLIT_SWITCHING_CONSTRAINT_RESIDUAL_HPP_
...
#include "roboc/ocp/split_switching_constraint_residual.hxx"

#endif // ROBOC_SPLIT_SWITCHING_CONSTRAINT_RESIDUAL_HPP_ 