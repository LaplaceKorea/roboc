#ifndef ROBOC_HYBRID_OCP_DISCRETIZATION_HPP_ 
#define ROBOC_HYBRID_OCP_DISCRETIZATION_HPP_
...
#include "roboc/hybrid/hybrid_ocp_discretization.hxx"

#endif // ROBOC_HYBRID_OCP_DISCRETIZATION_HPP_ 