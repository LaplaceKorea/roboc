#ifndef ROBOC_SPLIT_UNCONSTR_OCP_HPP_
#define ROBOC_SPLIT_UNCONSTR_OCP_HPP_
...
#include "roboc/unconstr/split_unconstr_ocp.hxx"

#endif // ROBOC_SPLIT_UNCONSTR_OCP_HPP_ 