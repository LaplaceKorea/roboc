#ifndef ROBOC_TIME_VARYING_CONFIGURATION_SPACE_COST_HPP_
#define ROBOC_TIME_VARYING_CONFIGURATION_SPACE_COST_HPP_
...
#endif // ROBOC_TIME_VARYING_CONFIGURATION_SPACE_COST_HPP_ 