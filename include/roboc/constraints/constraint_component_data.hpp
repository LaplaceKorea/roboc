#ifndef ROBOC_CONSTRAINT_COMPONENT_DATA_HPP_
#define ROBOC_CONSTRAINT_COMPONENT_DATA_HPP_
...
#include "roboc/constraints/constraint_component_data.hxx"

#endif // ROBOC_CONSTRAINT_COMPONENT_DATA_HPP_