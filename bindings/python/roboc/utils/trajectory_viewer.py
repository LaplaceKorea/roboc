...
class TrajectoryViewer:
    def __init__(self, path_to_urdf, path_to_pkg=None, 
        ...
        if viewer_type == 'gepetto':
            ...
            self.window_name = 'roboc.TrajectoryViewer'
    ...
    def display_gepetto(self, dt, q_traj, f_traj):
        ...
        if f_traj is not None:
            robot = roboc.Robot(self.path_to_urdf, self.base_joint_type, 
                                self.contact_frames)
    ...
    def display_meshcat(self, dt, q_traj, open=True):
        ...
        self.robot.loadViewerModel(rootNodeName='roboc.TrajectoryViewer')
