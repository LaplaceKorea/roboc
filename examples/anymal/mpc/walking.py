...
RH_t0 = t0
LF_foot_ref = roboc.PeriodicFootTrackRef2(q0_3d_LF, step_length, step_height, 
                                          LF_t0, period_swing, 3*period_swing, False)
LH_foot_ref = roboc.PeriodicFootTrackRef2(q0_3d_LH, step_length, step_height, 
                                          LH_t0, period_swing, 3*period_swing, False)
RF_foot_ref = roboc.PeriodicFootTrackRef2(q0_3d_RF, step_length, step_height, 
                                          RF_t0, period_swing, 3*period_swing, True)
RH_foot_ref = roboc.PeriodicFootTrackRef2(q0_3d_RH, step_length, step_height, 
...
com_ref = roboc.PeriodicCoMRef2(com_ref0, v_com_ref, t0, 2*period_swing, 0., True)
...
nthreads = 4
mpc = roboc.MPCQuadrupedalWalking(robot, cost, constraints, T, N, 
                                  max_steps, nthreads)
