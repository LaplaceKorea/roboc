...
com_ref_flying_up = roboc.PeriodicCoMRef(com_ref0_flying_up, v_com_ref_flying_up, 
                                         t0+period_ground, period_flying_up, 
                                         period_flying_down+2*period_ground, False)
com_cost_flying_up = roboc.TimeVaryingCoMCost(robot, com_ref_flying_up)
...
com_ref_landed = roboc.PeriodicCoMRef(com_ref0_landed, v_com_ref_landed, 
                                      t0+period_ground+period_flying, period_ground, 
                                      period_ground+period_flying, False)
com_cost_landed = roboc.TimeVaryingCoMCost(robot, com_ref_landed)
