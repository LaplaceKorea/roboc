...
int main () {
  ...
  auto contact_cost = std::make_shared<roboc::ContactForceCost>(robot);
  ...
  roboc::OCPSolver ocp_solver(robot, cost, constraints, T, N, 
  ...
  roboc::benchmark::convergence(ocp_solver, t, q, v, 10, false);
  roboc::benchmark::CPUTime(ocp_solver, t, q, v, 10000, false);
